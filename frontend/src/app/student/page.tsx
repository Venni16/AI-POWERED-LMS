...
import { BookOpen, CheckCircle, Clock, Award, LayoutDashboard, Search, DollarSign } from 'lucide-react';
...
export default function StudentDashboard() {
  ...
  const studentNavItems = [
    ...
    { id: 'purchased', label: 'Purchased Courses', icon: DollarSign, component: <PurchasedCourses /> },
  ];
